...
void flip_atlas(Atlas& src, Atlas& dst)
{
	...
	{
		IMAGE flipped_img;
		flip_image(src.get_image(i), &flipped_img);
		dst.add_image(flipped_img);
	}
}
	...
	
{
	...
	loadimage(&img_gravestone_right, _T("resources/gravestone_right.png"));
	...
	loadimage(&img_peashooter_selector_background_right, _T("resources/peashooter_selector_background_right.png"));
	flip_image(&img_peashooter_selector_background_right, &img_peashooter_selector_background_left);
	loadimage(&img_sunflower_selector_background_right, _T("resources/sunflower_selector_background_right.png"));
	...
	loadimage(&img_1P_winnner, _T("resources/1P_winnner.png"));
	loadimage(&img_2P_winnner, _T("resources/2P_winnner.png"));
